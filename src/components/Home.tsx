            ...
            <nav className="fixed top-0 left-0 w-full z-50 bg-black/66 backdrop-blur-md shadow-lg">
                <div className="justify-end max-w-7xl mx-auto py-4 flex items-center text-white">
                    ...
                    <ul className="flex space-x-6 text-sm font-medium">
                        ...
                        <li><HashLink smooth to="/#models" className="hover:text-green-600 transition">Models</HashLink></li>

                        <li><HashLink smooth to="/#footer" className="hover:text-green-700 transition">Contact</HashLink></li>
